                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" name="enterMessage"
                              action="processScheduleMessage.jsp" method="post"
                        ...
                        <button class="btn btn-lg btn-primary btn-block text-uppercase"
                                id="myBtnPSO">Preview & Schedule</button>
                        <hr class="my-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="dateDiv">Date : <input type="date" name="scheduleDate" id="scheduleDate" required>
                        Time (HH) :<input type="text" name="scheduleTimeHour" id="scheduleTimeHour" size="2" required>
                        (MM) :<input type="text" name="scheduleTimeMinute" id="scheduleTimeMinute" size="2" required>
                    </div>
                    <hr>
...
<script type="text/javascript">
    ...
    if (inputpin != '') {
    $('#myPin').val(inputpin)
    var time = $('#scheduleDate').val() + $('#scheduleTimeHour').val() + $('#scheduleTimeMinute').val()
    time = time.replace('-', '');
    time = time.replace('-', '');
    $('#myTime').val(time)
